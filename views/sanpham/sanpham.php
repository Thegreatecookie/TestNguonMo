                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <input name="id_dianhac" type="text" class="form-control" placeholder="điền mã">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Tên đĩa nhạc</label>
                                                                    <input name="tendianhac" type="text" class="form-control" placeholder="điền tên">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Mô tả</label>
                                                                    <textarea name="mota" type="text" class="form-control" cols="30" rows="4">
                                                                    </textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Giá</label>
                                                                    <input name="gia" type="number" class="form-control" placeholder="thêm giá tiền">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">

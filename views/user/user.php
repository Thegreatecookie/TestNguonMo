                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Thêm Đĩa Nhạc</h4>
                                ...
                                <div class="card-body">
                                    <!-- Modal -->
                                    <form method="POST" action="index.php?controller=usercontroller&action=them">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group form-group-default">
                                                                    <label>email</label>
                                                                    <input type="text" class="form-control" placeholder="Tên " name="email">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Tên</label>
                                                                    <input type="text" class="form-control" placeholder="Nhập tên" name="tenkh">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Mật khẩu</label>
                                                                    <input type="text-overflow" class="form-control" placeholder="Nhập mật khẩu" name="matkhau">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Số điện thoại</label>
                                                                    <input type="number" class="form-control" placeholder="nhập số điện thoại" name="sodienthoai">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                            ...
                                            <tbody>
                                                   <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $arr['sodienthoai'];?></td>
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                ...
                                                                <button type="submit" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove" ><a href="index.php?controller=usercontroller&action=delete&id=<?php echo $arr['email'];?>">

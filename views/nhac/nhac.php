                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Mã nhạc</label>
                                                                    <input name="id_nhac" type="text" class="form-control" placeholder="điền mã">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Tên nhạc</label>
                                                                    <input name="tennhac" type="text" class="form-control" placeholder="điền tên">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    <label>Tác Giả</label>
                                                                    <input name="tentacgia" type="text" class="form-control" placeholder="điền tên tác giả">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">

                ...
                <div class="page-inner">
                    <div class="page-header">
                     ...
                     <div class="row" >           
                            <div class="col-md-12">
                                <div class="card"> 
                                    <form method="POST" action="index.php?controller=nhaccontroller&action=xulysua&id=<?php echo $_GET['id']?>" enctype="multipart/form-data">
                                    <?php
                                    foreach ($data as $arr) {
                                    ?>
                                    <div class="card-header">
                                    <div class="card-title">Sửa đổi thông tin Nhạc</div>
                                    </div>                                                 
                                    <div class="card-body">                       
                                        <div class="row">  
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group form-group-default">
                                                    ...
                                                    <input name="tennhac" type="text" class="form-control" value="<?php echo $arr['tennhac']?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group form-group-default">
                                                    <label>Tác giả</label>
                                                    <input name="tentacgia" type="text" class="form-control" value="<?php echo $arr['tentacgia']?>">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6 pr-0">
                                                    <div class="form-group form-group-default">
                                                        <label>Video</label>
                                                        <input multiple type="file" name ="video" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
